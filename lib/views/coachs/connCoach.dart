...
class ConnCoach extends StatefulWidget {
  const ConnCoach({super.key});

  @override
  State<ConnCoach> createState() => _ConnCoachState();
}

class _ConnCoachState extends State<ConnCoach> {
   bool loading = false;
